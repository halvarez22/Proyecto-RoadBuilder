...
/** Tool de contacto WhatsApp — número oficial de atención */
export const WHATSAPP_E164 = '526147041000'
...
export default function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] left-[max(1rem,env(safe-area-inset-left))] z-30 inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200"
      aria-label={lang === 'en' ? 'Chat on WhatsApp' : 'Escribir por WhatsApp'}
    >
      <svg aria-hidden="true" viewBox="0 0 32 32" className="h-7 w-7 text-white">
        <path
          fill="currentColor"
